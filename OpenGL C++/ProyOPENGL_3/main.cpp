...
glColor3f(1, 0, 0);glVertex3f(100, 0.0, 0.0);
glColor3f(0.2, 0.6, 0);glVertex3f(0.0, 100, 0.0);
glColor3f(0, 0.2, 0.6);glVertex3f(-100, 0.0, 0.0);
glColor3f(0.6, 0.2, 1);glVertex3f(-50, -100, 0.0);
glColor3f(1, 0.2, 0.6);glVertex3f(50, -100, 0.0);
